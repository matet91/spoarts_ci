...
function getservices(){
	$('#service_list').DataTable( {
		...
		"fnRowCallback": function( nRow, aData, iDisplayIndex ) {
			if ( aData[6] == "1" ){
				$('td:eq(6)', nRow).html('<button class = "btn btn-primary btn-viewlist" data-toggle="tooltip" data-placement="top" title="View Students and Instructors" id="view_studinstruct" onclick="view_studinstruct('+aData[0]+');"><span class = "glyphicon glyphicon-list"></span></button>' );
			}
